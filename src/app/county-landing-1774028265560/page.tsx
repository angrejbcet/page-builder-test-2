...
import { county_landing_1774028265560PageData, county_landing_1774028265560PageMetadata, county_landing_1774028265560PageJsonLd } from "@/content/pages/county-landing-1774028265560";

export const metadata: Metadata = county_landing_1774028265560PageMetadata;

export default function CountyLanding1774028265560Page() {
  const { sections } = county_landing_1774028265560PageData;
  return (
    <>
      {county_landing_1774028265560PageJsonLd ? (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(county_landing_1774028265560PageJsonLd) }}
        />
      ) : null}
