...
import { service_custom_1774028376832PageData, service_custom_1774028376832PageMetadata, service_custom_1774028376832PageJsonLd } from "@/content/pages/service-custom-1774028376832";

export const metadata: Metadata = service_custom_1774028376832PageMetadata;

export default function ServiceCustom1774028376832Page() {
  const { sections } = service_custom_1774028376832PageData;
  return (
    <>
      {service_custom_1774028376832PageJsonLd ? (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(service_custom_1774028376832PageJsonLd) }}
        />
      ) : null}
