...
import { service_subservice_1774028380174PageData, service_subservice_1774028380174PageMetadata, service_subservice_1774028380174PageJsonLd } from "@/content/pages/service-subservice-1774028380174";

export const metadata: Metadata = service_subservice_1774028380174PageMetadata;

export default function ServiceSubservice1774028380174Page() {
  const { sections } = service_subservice_1774028380174PageData;
  return (
    <>
      {service_subservice_1774028380174PageJsonLd ? (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(service_subservice_1774028380174PageJsonLd) }}
        />
      ) : null}
