...
import { service_subservice_1774028406492PageData, service_subservice_1774028406492PageMetadata, service_subservice_1774028406492PageJsonLd } from "@/content/pages/service-subservice-1774028406492";

export const metadata: Metadata = service_subservice_1774028406492PageMetadata;

export default function ServiceSubservice1774028406492Page() {
  const { sections } = service_subservice_1774028406492PageData;
  return (
    <>
      {service_subservice_1774028406492PageJsonLd ? (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(service_subservice_1774028406492PageJsonLd) }}
        />
      ) : null}
