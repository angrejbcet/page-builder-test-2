...
const SECTION_DEFINITIONS: SectionDef[] = [
  ...
  {
    id: "dynamicBlogPageContent",
    path: "@/public/sections/DynamicBlogPageContentSection",
    component: "DynamicBlogPageContentSection",
    propsType: "BlogPostContentProps",
    loader: () => import("@/public/sections/DynamicBlogPageContentSection").then((m) => ({ default: m.DynamicBlogPageContentSection as React.ComponentType<any> }))
  },
  {
    id: "blogPostContent",
