...
function ServiceGrid({ heading, highlight, cards, imageShape, elementStyles }: Omit<ServiceCardsProps, "variant">) {
  ...
  return (
    <section className={cn("py-12 @min-[768px]:py-24 px-4 @min-[768px]:px-8", !hasSectionBg && "bg-secondary")}>
      <div className="max-w-[1325px] mx-auto">
        ...
        <div className="grid @min-[640px]:grid-cols-2 @min-[1024px]:grid-cols-3 gap-4 @min-[768px]:gap-6">
          {cards.map((card, idx) => (
...
function ServiceCompact({ heading, highlight, cards, imageShape, elementStyles }: Omit<ServiceCardsProps, "variant">) {
  ...
  return (
    <section className={cn("py-12 @min-[768px]:py-24 px-4 @min-[768px]:px-8", !hasSectionBg && "bg-secondary")}>
      <div className="max-w-[1325px] mx-auto">
        ...
        <div className="grid @min-[640px]:grid-cols-2 @min-[1024px]:grid-cols-4 gap-4">
          {cards.map((card, idx) => {
...
function ServiceOverlay({ heading, highlight, subheading, cards, imageShape, elementStyles }: Omit<ServiceCardsProps, "variant">) {
  const shape = resolveShape(imageShape);
  const hasSectionBg = !!elementStyles?._sectionBg;
  ...
  return (
    <section className={cn("py-12 @min-[768px]:py-24 px-4 @min-[768px]:px-8", !hasSectionBg && "bg-secondary")}>
      <div className="max-w-[1325px] mx-auto">
        ...
        <div className="grid grid-cols-1 @min-[640px]:grid-cols-2 @min-[1024px]:grid-cols-4 gap-4 @min-[768px]:gap-5">
          {cards.map((card, idx) => (
            <Link
...
export const ServiceCards: React.FC<ServiceCardsProps> = ({
  ...
  const shape = resolveShape(imageShape);
  const hasSectionBg = !!elementStyles?._sectionBg;
  if (variant === "grid") return <ServiceGrid heading={heading} highlight={highlight} cards={cards} imageShape={imageShape} elementStyles={elementStyles} />;
  if (variant === "compact") return <ServiceCompact heading={heading} highlight={highlight} cards={cards} imageShape={imageShape} elementStyles={elementStyles} />;
  if (variant === "overlay") return <ServiceOverlay heading={heading} highlight={highlight} subheading={subheading} cards={cards} imageShape={imageShape} elementStyles={elementStyles} />;
